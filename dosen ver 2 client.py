...
class BankClient:
    ...
    def export_data(self):
        pass  # Placeholder for exporting data to the server
       
    def import_data(self):
        pass  # Placeholder for importing data from the server
    ...
    def add_data(self):
        ...
        ttk.Button(new_window, text="Tambah Data", command=lambda: self.send_to_server(entries)).grid(row=len(columns), column=0, columnspan=2, pady=10)
    ...
    def update_data(self):
        ...
        # ... (your update data frame code)

    def send_to_server(self, entries):
